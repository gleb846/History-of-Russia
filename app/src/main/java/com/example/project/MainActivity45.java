    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        but.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(MainActivity45.this, MainActivity39.class);
                startActivity(in);
                finish();
            }
        });
        ...
        buon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(MainActivity45.this, MainActivity41.class);
                startActivity(in);
                finish();
            }
        });

        Button butt = (Button) findViewById(R.id.button16);//термины и понятия
