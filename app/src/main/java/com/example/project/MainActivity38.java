    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(MainActivity38.this, MainActivity39.class);
                startActivity(in);
                finish();
            }
        });
        ...
        but.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in = new Intent(MainActivity38.this, MainActivity40.class);
                startActivity(in);
                finish();
            }
        });
        ...
        Button buon = (Button) findViewById(R.id.button16);
